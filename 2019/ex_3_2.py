def get_coor_list(in_list):
    cur_coor=[0, 0, 0] # [x, y, travel_cost]
    res_list = []
    for i in in_list:
        direction = i[0]
        it = int(i[1:])
...
if __name__ == "__main__":
    ...
    # l_cable_1 = ["R8","U5","L5","D3"]
    # l_cable_2 = ["U7","R6","D4","L4"]

    # l_cable_1 = ["R98","U47","R26","D63","R33","U87","L62","D20","R33","U53","R51"]
    # l_cable_2 = ["U98","R91","D20","R16","D67","R40","U7","R15","U6","R7"]

    l_cable_1_xy = get_coor_list(l_cable_1)
    l_cable_2_xy = get_coor_list(l_cable_2)

    # l_join_xy = list_comp(l_cable_1_xy, l_cable_2_xy)
    l_distances = list_comp(l_cable_1_xy, l_cable_2_xy)
